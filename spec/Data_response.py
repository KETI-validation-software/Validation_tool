# Authentication
cmsiluan100bvrc0qiag2o6bg_Authentication_out_data = {
    "code": "200",
    "message": "성공",
    "userName": "관리자",
    "userAff": "오산시청",
...
# Capabilities
cmsiluan100bvrc0qiag2o6bg_Capabilities_out_data = {
    "code": "200",
    "message": "성공",
    "streamingSupport": [
        {
...
# CameraProfiles
cmsiluan100bvrc0qiag2o6bg_CameraProfiles_out_data = {
    "code": "200",
    "message": "성공",
    "camList": [
        {
...
# StoredVideoInfos
cmsiluan100bvrc0qiag2o6bg_StoredVideoInfos_out_data = {
    "code": "200",
    "message": "성공",
    "camList": [
        {
...
# ReplayURL
cmsiluan100bvrc0qiag2o6bg_ReplayURL_out_data = {
    "code": "200",
    "message": "성공",
    "camList": [
        {
...
cmsiluan100bvrc0qiag2o6bg_StoredVideoEventInfos_out_data = {
    "code": "200",
    "message": "성공",
    "camList": [
        {
...
cmsiluan100bvrc0qiag2o6bg_StoredObjectAnalyticsInfos_out_data = {
    "code": "200",
    "message": "성공",
    "camList": [
        {
...
# cmsiluan100bvrc0qiag2o6bg 데이터 리스트
cmsiluan100bvrc0qiag2o6bg_outData = [
    cmsiluan100bvrc0qiag2o6bg_Authentication_out_data,
    cmsiluan100bvrc0qiag2o6bg_Capabilities_out_data,
    cmsiluan100bvrc0qiag2o6bg_CameraProfiles_out_data,
    cmsiluan100bvrc0qiag2o6bg_StoredVideoInfos_out_data,
...
# cmsiluan100bvrc0qiag2o6bg API endpoint
cmsiluan100bvrc0qiag2o6bg_messages = [
    "Authentication",
    "Capabilities",
    "CameraProfiles",
    "StoredVideoInfos",
...
# Authentication
cmsmgmbhm01ebrc0qs9uiok8n_Authentication_out_data = {
    "code": "200",
    "message": "성공",
    "userName": "관리자",
    "userAff": "오산시청",
...
# Capabilities
cmsmgmbhm01ebrc0qs9uiok8n_Capabilities_out_data = {
    "code": "200",
    "message": "성공",
    "transportSupport": [
        {
...
# DoorProfiles
cmsmgmbhm01ebrc0qs9uiok8n_DoorProfiles_out_data = {
    "code": "200",
    "message": "성공",
    "doorList": [
        {
...
# AccessUserInfos
cmsmgmbhm01ebrc0qs9uiok8n_AccessUserInfos_out_data = {
    "code": "200",
    "message": "성공",
    "userList": [
        {
...
cmsmgmbhm01ebrc0qs9uiok8n_StoredVerifEventInfos_out_data = {
    "code": "200",
    "message": "성공",
    "doorList": [
        {
...
# cmsmgmbhm01ebrc0qs9uiok8n 데이터 리스트
cmsmgmbhm01ebrc0qs9uiok8n_outData = [
    cmsmgmbhm01ebrc0qs9uiok8n_Authentication_out_data,
    cmsmgmbhm01ebrc0qs9uiok8n_Capabilities_out_data,
    cmsmgmbhm01ebrc0qs9uiok8n_DoorProfiles_out_data,
    cmsmgmbhm01ebrc0qs9uiok8n_AccessUserInfos_out_data,
...
# cmsmgmbhm01ebrc0qs9uiok8n API endpoint
cmsmgmbhm01ebrc0qs9uiok8n_messages = [
    "Authentication",
    "Capabilities",
    "DoorProfiles",
    "AccessUserInfos",
...
# Authentication
cmsmh2go501w6rc0q4s8zyqdp_Authentication_out_data = {
    "code": "200",
    "message": "성공",
    "userName": "관리자",
    "userAff": "오산시청",
...
# Capabilities
cmsmh2go501w6rc0q4s8zyqdp_Capabilities_out_data = {
    "code": "200",
    "message": "성공",
    "transportSupport": [
        {
...
cmsmh2go501w6rc0q4s8zyqdp_SensorDeviceProfiles_out_data = {
    "code": "200",
    "message": "성공",
    "sensorDeviceList": [
        {
...
cmsmh2go501w6rc0q4s8zyqdp_StoredSensorEventInfos_out_data = {
    "code": "200",
    "message": "성공",
    "sensorDeviceList": [
        {
...
# cmsmh2go501w6rc0q4s8zyqdp 데이터 리스트
cmsmh2go501w6rc0q4s8zyqdp_outData = [
    cmsmh2go501w6rc0q4s8zyqdp_Authentication_out_data,
    cmsmh2go501w6rc0q4s8zyqdp_Capabilities_out_data,
    cmsmh2go501w6rc0q4s8zyqdp_SensorDeviceProfiles_out_data,
    cmsmh2go501w6rc0q4s8zyqdp_StoredSensorEventInfos_out_data,
...
# cmsmh2go501w6rc0q4s8zyqdp API endpoint
cmsmh2go501w6rc0q4s8zyqdp_messages = [
    "Authentication",
    "Capabilities",
    "SensorDeviceProfiles",
    "StoredSensorEventInfos",
