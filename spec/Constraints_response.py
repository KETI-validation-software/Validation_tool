...
cmiqr1acx00i5ie8fi022t1hp_RealtimeDoorStatus_webhook_in_constraints = {
  ...
  "doorList.doorName": {
    "id": "cmjsb049v0u20cfb3qbfasxuo",
    "valueType": "preset",
    "required": True
  },
  "doorList.doorRelaySensor": {
    "id": "cmjsb0fn00u3icfb3cyzqinrs",
    "valueType": "preset",
    "required": True
  },
  "doorList.doorSensor": {
    "id": "cmjsb0irh0u3scfb3mw9ss6vy",
    "valueType": "random",
    "required": True,
    "referenceField": "(참조 필드 미선택)",
    "referenceEndpoint": "/RealtimeDoorStatus",
...
cmiqr1acx00i5ie8fi022t1hp_RealtimeDoorStatus2_webhook_in_constraints = {
  ...
  "doorList.doorID": {
    ...
    "referenceFieldId": "cmiwqsji80b7m844ghp9sizpj",
    "valueType": "request-based",
    "required": True,
  ...
  "doorList.doorName": {
    "id": "cmjsb2abv0u5scfb3o958ahrv",
    "valueType": "preset",
    "required": True
  },
  "doorList.doorRelaySensor": {
    "id": "cmjsb2shk0u6ecfb3nw1dusev",
    "valueType": "preset",
    "required": True
  },
  "doorList.doorSensor": {
    "id": "cmjsb2vui0u6wcfb3qv2labav",
    "valueType": "random",
    "required": True,
    "referenceField": "(참조 필드 미선택)",
    "referenceEndpoint": "/RealtimeDoorStatus",
