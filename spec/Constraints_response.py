...
cmii7lxbn002s8z1t1i9uudf0_CameraProfiles_out_constraints = {
  ...
  "camList": {
    "id": "cmir0ll0k00bu4m39buqwuv6i",
    "valueType": "preset",
    "required": True
  },
  "camList.camID": {
    "id": "cmir0ll0o00bw4m39kqayyk7r",
    "valueType": "preset",
    "required": True
  },
  "camList.camName": {
    "id": "cmir0ll0p00by4m39uwgiy19u",
    "valueType": "preset",
    "required": True
  },
  "camList.camLoc": {
    "id": "cmir0ll0q00c04m39om950768",
    "valueType": "preset",
    "required": False
  },
  "camList.camLoc.lon": {
    "id": "cmir0ll0x00c44m39zwdnatab",
    "valueType": "preset",
    "required": True
  },
  "camList.camLoc.lat": {
    "id": "cmir0ll0y00c64m39ukpos071",
    "valueType": "preset",
    "required": True
  },
  "camList.camLoc.alt": {
    "id": "cmir0ll0y00c84m39yhv6zkua",
    "valueType": "preset",
    "required": False
  },
  "camList.camLoc.desc": {
    "id": "cmir0e9xg006f4m393tqpkwxj",
    "valueType": "preset",
    "required": False
  },
  "camList.camConfig": {
    "id": "cmir0ll0q00c24m397lcok7iw",
    "valueType": "preset",
    "required": False
  },
  "camList.camConfig.camType": {
    "id": "cmir0ll0z00ca4m39txuezlro",
    "valueType": "preset",
    "required": True
  }
}
...
cmii7lxbn002s8z1t1i9uudf0_StreamURLs_out_constraints = {
  ...
  "camList": {
    "id": "cmir1ncw202bo4m393sgzc3rg",
    "valueType": "preset",
    "required": True
  },
  "camList.camID": {
    "id": "cmir1ncw602bq4m39qm4p037c",
    "valueType": "preset",
    "required": True
  },
  "camList.accessID": {
    "id": "cmir1ncw702bs4m39rjk0chez",
    "valueType": "preset",
    "required": False
  },
  "camList.accessPW": {
    "id": "cmir1ncw702bu4m39yhzsrzjp",
    "valueType": "preset",
    "required": False
  },
  "camList.camURL": {
    "id": "cmir1ncw802bw4m39kvbh7d0d",
    "valueType": "preset",
    "required": False
  },
  "camList.videoInfo": {
    "id": "cmir1ncw802by4m39mmmqq78m",
    "valueType": "preset",
    "required": False
  },
  "camList.videoInfo.resolution": {
    "id": "cmir1ncwg02c04m39lbd0bf7e",
    "valueType": "preset",
    "required": False
  },
  "camList.videoInfo.fps": {
    "id": "cmir1ncwg02c24m39nd5kgmm6",
    "valueType": "preset",
    "required": False
  },
  "camList.videoInfo.videoCodec": {
    "id": "cmir1ncwh02c44m39tfgvkv8s",
    "valueType": "preset",
    "required": False
  },
  "camList.videoInfo.audioCodec": {
    "id": "cmir1ncwh02c64m39umcgr8wq",
    "valueType": "preset",
    "required": False
  }
}
...
cmii7lxbn002s8z1t1i9uudf0_RealtimeVideoEventInfos_webhook_in_constraints = {
  "camList": {
    "id": "cmir2mfj402x34m39azjqh5ms",
    "valueType": "preset",
    "required": True
  },
  "camList.camID": {
    "id": "cmir2mfj802x54m39ovsi5ohs",
    "valueType": "preset",
    "required": True
  },
  "camList.eventUUID": {
    "id": "cmir2mfj802x74m39rmn1ayqc",
    "valueType": "preset",
    "required": True
  },
  "camList.eventName": {
    "id": "cmir2mfj902x94m39bi2uybx3",
    "valueType": "preset",
    "required": True
  },
  "camList.startTime": {
    "id": "cmir2mfj902xb4m39dem07ktk",
    "valueType": "preset",
    "required": True
  },
  "camList.endTime": {
    "id": "cmir2mfja02xd4m39q4thhwom",
    "valueType": "preset",
    "required": False
  },
  "camList.eventDesc": {
    "id": "cmir2mfja02xf4m39l9ldz578",
    "valueType": "preset",
    "required": False
  }
}
