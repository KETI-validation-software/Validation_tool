# Authentication
cmsiluan100bvrc0qiag2o6bg_Authentication_in_validation = {
  "userID": {
    "enabled": True,
...
# Capabilities
cmsiluan100bvrc0qiag2o6bg_Capabilities_in_validation = {}

# CameraProfiles
cmsiluan100bvrc0qiag2o6bg_CameraProfiles_in_validation = {}

# StoredVideoInfos
cmsiluan100bvrc0qiag2o6bg_StoredVideoInfos_in_validation = {
  "camList.camID": {
    "enabled": True,
    "validationType": "response-field-list-match",
    "referenceFieldId": "cmsiluatd00etrc0q98i6huaq",
...
# ReplayURL
cmsiluan100bvrc0qiag2o6bg_ReplayURL_in_validation = {
  "camList.camID": {
    "enabled": True,
    "validationType": "response-field-list-match",
    "referenceFieldId": "cmsiluatd00etrc0q98i6huaq",
...
cmsiluan100bvrc0qiag2o6bg_StoredVideoEventInfos_in_validation = {
  "camList.camID": {
    "enabled": True,
    "validationType": "response-field-list-match",
    "referenceFieldId": "cmsiluatd00etrc0q98i6huaq",
...
cmsiluan100bvrc0qiag2o6bg_StoredObjectAnalyticsInfos_in_validation = {
  "camList.camID": {
    "enabled": True,
    "validationType": "response-field-list-match",
    "referenceFieldId": "cmsiluatd00etrc0q98i6huaq",
...
cmsiluan100bvrc0qiag2o6bg_inValidation = [
    cmsiluan100bvrc0qiag2o6bg_Authentication_in_validation,
    cmsiluan100bvrc0qiag2o6bg_Capabilities_in_validation,
    cmsiluan100bvrc0qiag2o6bg_CameraProfiles_in_validation,
    cmsiluan100bvrc0qiag2o6bg_StoredVideoInfos_in_validation,
...
# Authentication
cmsmgmbhm01ebrc0qs9uiok8n_Authentication_in_validation = {
  "userID": {
    "enabled": True,
    "validationType": "specified-value-match",
    "allowedValues": [
...
# Capabilities
cmsmgmbhm01ebrc0qs9uiok8n_Capabilities_in_validation = {}

# DoorProfiles
cmsmgmbhm01ebrc0qs9uiok8n_DoorProfiles_in_validation = {}

# AccessUserInfos
cmsmgmbhm01ebrc0qs9uiok8n_AccessUserInfos_in_validation = {}

# StoredVerifEventInfos
cmsmgmbhm01ebrc0qs9uiok8n_StoredVerifEventInfos_in_validation = {
  "eventFilter": {
    "enabled": True,
    "validationType": "valid-value-match",
    "validValueMatchType": "validation-field",
...
cmsmgmbhm01ebrc0qs9uiok8n_inValidation = [
    cmsmgmbhm01ebrc0qs9uiok8n_Authentication_in_validation,
    cmsmgmbhm01ebrc0qs9uiok8n_Capabilities_in_validation,
    cmsmgmbhm01ebrc0qs9uiok8n_DoorProfiles_in_validation,
    cmsmgmbhm01ebrc0qs9uiok8n_AccessUserInfos_in_validation,
...
cmsmh2go501w6rc0q4s8zyqdp_StoredSensorEventInfos_in_validation = {
  "sensorDeviceList.sensorDeviceID": {
    "enabled": True,
    "validationType": "response-field-list-match",
    "referenceFieldId": "cmsmh2grb01xqrc0qegaqm27m",
