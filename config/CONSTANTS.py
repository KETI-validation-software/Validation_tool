...
specs = [["cmiqr1jha00i6ie8fb1scb3go_outSchema","cmiqr1jha00i6ie8fb1scb3go_inData","cmiqr1jha00i6ie8fb1scb3go_messages",""],
         ...
         ["cmii7wfuf006i8z1tcds6q69g_outSchema","cmii7wfuf006i8z1tcds6q69g_inData","cmii7wfuf006i8z1tcds6q69g_messages",""],
...
version = "keti3"
test_category = "본시험"
test_target = "제어 기능 시험-바이오인식 기반 출입통제 시스템 외 3개"
test_range = "전체 필드"
auth_type = "Digest Auth"
auth_info = "kisa,kisa_k1!2@"
admin_code = "123456"
url = "https://10.252.219.53:8080"
contact_person = "keti3"
model_name = "keti3"
request_id = "cmn5mqunu000azgj44a6ethun"
...
SPEC_CONFIG = [
    ...
    "api_name": ['사용자 인증', '전송 지원 기능 정보 연동', '실시간 영상(CCTV) 전송 ', '저장된 영상 목록 연동', '저장된 객체 분석 정보 연동'],
    "api_id": ['cmii7ylxn006m8z1tqq8dard1', 'cmiqtf9x600upie8ft45b1h1w', 'cmiqtkefj00whie8fd8odtc1m', 'cmiwrkvjq0005nkgl04g93wwy', 'cmiws9btu01ksp0028h4uc4az'],
    "api_endpoint": ['/Authentication', '/Capabilities', '/StreamURLs', '/StoredVideoInfos', '/StoredObjectAnalyticsInfos'],
    "trans_protocol": ['basic', 'basic', None, 'basic', None, 'basic', None, None, 'basic'],
    "time_out": [60000, 60000, 5000, 60000, 5000, 10000, 5000, 5000, 60000],
