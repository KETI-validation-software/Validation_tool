...
SPEC_CONFIG = [
    ...
    "api_name": ['인증', '바이오 및 출입통제 장치 목록 정보', '실시간 출입통제 장치 상태 정보 연동', '출입 통제 장치 제어 정보 연동'],
    "api_id": ['step-1-n98lp4ycz', 'step-2-koi3uz7qa', 'step-3-w3ms6ohgy', 'step-4-9fqdmyoou'],
